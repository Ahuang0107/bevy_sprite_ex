...
/// A [`Bundle`] of components for drawing a single sprite mask from an image.
#[derive(Bundle, Clone, Debug, Default)]
pub struct SpriteMaskBundle {
    /// Specifies the rendering properties of the sprite mask, such as flip.
